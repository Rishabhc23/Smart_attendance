...
face.option_add("*Font", "helvetica 20 bold")
...
def login():
    if username_var.get() == "" or password_var.get() == "":
        ...
        try:
            conn = pymysql.connect(host = 'localhost', user = 'root', password = 'password', database = 'recognitor', port=3306)
            curr = conn.cursor()
            ...
            if row == None:
                ...
                def manage_employee():
                    try:
                        ...
                        background_pic.pack()
                        first.title("Manage Students")
                        print("Hi Rishabh")
                        face = Label(first, text = "Management of Student" , bg = "green" , fg = "yellow", padx = 15, pady = 15, font = ("helvetica", 20, "bold italic") ,borderwidth = 5, relief = RIDGE).place(x = 500, y = 10)
                        main = Label(first, bg = "gray", borderwidth = 1).pack()
                        def back():
                            first.destroy() 
                        backbtn = Button(first, text = 'Back', font = ('helvetica', 15), fg = 'black', bg = 'white', height = 1, width = 7, command = back).place(x = 1250, y = 10)  
                    ...
                    ################################################## Employee Management form ###############################
                        ...
                        titles = Label(f2, text = "Manage Student" ,bg = "gray", font = ("Italic", 20, "bold italic")).place(x = 90, y = 30)
                        id = Label(f2, text = "Student Roll no.", bg = "gray", font = ("italic",13, "bold")).place(x = 35, y = 100 )
                        E1 = Entry(f2,state="disabled", width = 20, textvariable = eid_var,  font = ("italic",13, "bold") ).place(x = 180  , y = 100)
                        post = Label(f2, text = "Course", bg = "gray",  font = ("italic",13, "bold")).place(x = 35, y = 140 )
                        E2 = Entry(f2, width = 20, textvariable = post_var,  font = ("italic",13, "bold")).place(x =180, y = 140)
                        name = Label(f2, text = "Full Name", bg = "gray", font = ("italic",13, "bold")).place(x =35, y = 180)
                        E3 = Entry(f2, width = 20, textvariable = fname_var , font = ("italic",12, "bold")).place(x = 180, y = 180)
                        gender = Label(f2, text = "Gender", bg = "gray", font = ("italic",12, "bold")).place(x = 35, y= 220)
                        E7 = Combobox(f2, textvariable = gender_var , values = ["Male","Female"], state = "readonly",  font = ("italic",11, "bold")).place(x = 180, y = 220)
                        no = Label(f2, text = "Contact No.", bg = "gray", font = ("italic",12, "bold")  ).place(x = 35, y = 260)
                        E4 = Entry(f2, width = 20, textvariable = contact_var , font = ("italic",12, "bold") ).place(x = 180, y = 260 ) 
                        address = Label(f2, text = " Email Address", bg = "gray", font = ("italic",12, "bold")).place(x = 35, y = 300)
                        E5 = Entry(f2, width = 20, textvariable = address_var , font = ("italic",12, "bold") ).place(x = 180, y = 300)
                        year = Label(f2, text = "Year", bg = "gray", font = ("italic",12, "bold")).place(x = 35, y= 340)
                        E8 = Combobox(f2, textvariable = year_var , values = ["2020-2022","2021-2023","2023-2025","2024-2026"], state = "readonly",  font = ("italic",11, "bold")).place(x = 180, y =340 )
                        sem = Label(f2, text = "Semester", bg = "gray", font = ("italic",12, "bold")).place(x = 35, y= 380)
                        E9 = Combobox(f2, textvariable = sem_var , values = ["I","II","III","IV"], state = "readonly",  font = ("italic",11, "bold")).place(x = 180, y = 380)
                        teach = Label(f2, text = "Teacher's Name", bg = "gray", font = ("italic",12, "bold")).place(x = 35, y= 420)
                        E10 = Entry(f2, width = 20, textvariable = teach_var,  font = ("italic",13, "bold")).place(x =180, y = 420)
                        ...
                        btn1 = Button(f3, text = "Add", bg = "green", height = "1", width = "7",command = add_employee, font = ("helvetica", 14 , "bold")).place(x = 10, y = 10)
                        btn2 = Button(f3, text = "Update", bg = "green", height = "1", width = "7", command = update, font = ("helvetica", 14 , "bold")).place(x = 105, y = 10)
                        btn3 = Button(f3, text = "Delete", bg = "green",  height = "1", width = "7", command = delete,  font = ("helvetica", 14 , "bold")).place(x = 205, y = 10)
                        btn4 = Button(f3, text = "Clear", bg = "green", height = "1", width = "7", command = clear, font = ("helvetica", 14 , "bold")).place(x = 305, y = 10)
                        # btn5 = Button(f3, text = "Add Photo Sample", bg = "yellow", height = "2", width = "34",command = add_photo, font = ("helvetica", 14 , "bold")).place(x = 10, y = 60)
                        f3.place(x = 20, y = 550)
                    ################################################################################### Large Frame
                        f4 = Frame(first, height = 600, width = 900, bg = "gray", borderwidth = "3", relief = SUNKEN)
                        f4.place(x = 440, y = 90)
                        l1 = Label(first, text = "Search By:",font = ("helvetica", 18 ,"bold"),bg = "gray", fg = "white").place(x = 460, y = 100 )
                        c1 = Combobox(first, textvariable = search_from, values = ["eid","fname","post"], state = "readonly", width = "25").place(x = 580, y = 109)
                        E7 = Entry(first, textvariable = search_result, width = "25", font = ("helvetica",10) ).place(x = 780, y = 109)
                        btn7 = Button(first,  text = "Search ",  height = "1", width = "16", command = search_data, font = ("helvetica", 13 , "bold")).place(x = 960, y = 100 )
                        btn8 = Button(first, text = "Show All",  height = "1", width = "16", command = show_data, font = ("helvetica", 13 , "bold")).place(x = 1150, y = 100)
                    ################################################################################## Table frame
                        ...
                        table1.heading("eid", text ="Student Roll No.")
                        table1.heading('post', text = "Course")
                ...
                def train(): 
                    try:
                        ...
                        backgrd.pack()
                        train_title = Label(second, text = "Train the System", fg = 'white', font = ("helvetica", 20, "bold"), bg = "brown")
                        ...
                        def back():
                            second.destroy()   
                        backbtn = Button(second, text = 'Back', fg = 'black', bg = 'white', font = ('helvetica', 15), height = 1, width = 7, command = back).place(x = 1260, y = 3)
                        ...
                        btn = Button(second, text = "Start Training", fg = 'white',font = ("helvetica", 20, "bold"), command = progress, bg = "green" )
    ...
    ######################################### Function to recognize the face
                ...
                def change():
                    ...
                    title = Label(account_frame, text = "Admin Account", font = ('helvetica', 20, 'bold') , fg = 'green', bd = 3, relief = SUNKEN)    
                    ...
                    newpass_var = StringVar()
                    backbtn = Button(account, text = 'Back' , bg = "gray" , fg = "white",font = ("helvetica", 13, "bold") ,borderwidth = 1, relief = RIDGE, command = back).place(x = 445, y = 7)
                    ...
                    pass_label = Label(account_frame, text = 'Old Password', font = ('helvetica', 14, 'bold')).place(x = 55, y = 215)
                    pass_entry = Entry(account_frame, show  = '*', font = ('helvetica', 14, 'bold'), textvariable = oldpass_var).place(x = 210, y = 215)
                    user_icon = PhotoImage(file = 'Photos/user.png', master = account)
                    user_logo = Label(account_frame, image = user_icon).place(x = 7, y = 265)
                    user_label = Label(account_frame, text = 'New Username', font = ('helvetica', 14, 'bold')).place(x = 55, y = 275)
                    user_entry = Entry(account_frame, font = ('helvetica', 14, 'bold'), textvariable = newuser_var).place(x = 210, y = 275)
                    newpass_logo = Label(account_frame, image = pass_icon).place(x = 7, y = 325)
                    newpass_label = Label(account_frame, text = 'New Password', font = ('helvetica', 14, 'bold')).place(x = 55, y = 335)
                    newpass_entry = Entry(account_frame, show = '*', font = ('helvetica', 14, 'bold'), textvariable = newpass_var).place(x = 210, y = 325)
                    ...
                    btn = Button(account_frame, text = 'Reset', font = ('helvetica', 14, 'bold'), width = 10 , bg = 'green', command = user_change, relief = GROOVE).place(x = 240, y = 380 )
                    account.mainloop()   
                ...
                def report():
                    ...
                    title_label = Label(title, text = "Attendance Report", font = ("helvetica", 30, "bold"), fg = "white", bg = "maroon")
                    title_label.pack()
                    def back():
                        report.destroy()
                    backbtn = Button(title, text = 'Back' , bg = "blue" , fg = "white", font = ("helvetica", 20 ,"bold"), relief = RIDGE, command = back).place(x = 1250, y = 0)
                    ...
                    search_label = Label(text_fill, text = "Search By:", font = ("helvetica", 15, "bold"), bg = "yellow")
                    search_label.place(x = 10, y = 13)
                    search_combo = Combobox(text_fill, textvariable = search_by, values = ['date', 'name'], state = 'readonly', font = ("helvetica", 15),width = 15)
                    search_combo.place(x = 110, y = 13)
                    search_entry = Entry(text_fill, textvariable = search_text,  font = ("helvetica", 15 ), width = 15)
                    search_entry.place(x = 330 , y = 13)
                    search_btn = Button(text_fill, text = "Search", font = ("helvetica", 15, "bold"), command = search_data, width = 15)
                    search_btn.place(x = 540, y = 10)
                    search_today = Button(text_fill, text = "Delete", font = ("helvetica", 15, "bold"), command = delete_data, width = 15)
                    search_today.place(x = 840, y = 10 )
                    show_btn = Button(text_fill,  height = "1", text = "Show All", font = ("helvetica", 15, "bold"), command = show_data, width = 15)
                ...
                def face_embedding():
                    ...
                    backgrd.pack()
                    embed_title = Label(fe, text = "Extract And Save Embeddings",font = ("helvetica", 30, "bold"), bg = "brown")
                    ...
                    if not os.path.exists(embeddings_model_file):
                        ...
                        def back():
                            fe.destroy()
                        backbtn = Button(fe, text = 'Back', fg = 'White', bg = 'green', font = ('helvetica', 18 , 'bold'), command = back).place(x = 1250, y = 1)
                        l = len(face_pixels)
                        percent = StringVar()
                        text = StringVar()  
                        ...
                        btn = Button(fe,text="Start Extracting Embeddings",fg = 'white', font = ("helvetica", 20, "bold"),command=lambda: start_extracting_embedding(pixels=face_pixels),bg="green")
                ...
                topic = Label(attendance, text = manage , bg = "blue" , fg = "yellow", padx = 15, pady = 15, font = ("Verdana", 20, "bold italic") ,borderwidth = 5, relief = GROOVE)
                topic.place (x = 0, y = 0,relwidth = 1)
                # faceslider()
                # faceslidercolor()

                photo1 = PhotoImage(file = "Photos/management.png", master = attendance)
                B1 = Button(attendance, image = photo1, text = "Student Management",font = ("helvetica" , 15,'bold italic'), fg = "green", height =230, width = 265, command = manage_employee, compound = BOTTOM,borderwidth=5, relief=RAISED )
                B1.place(x = 20, y = 100)

                photo2 = PhotoImage(file = "Photos/face_recognizer.png",  master = attendance)
                B2 = Button(attendance, image = photo2 , text = "Face Recognizer", font = ("helvetica", 15, 'bold italic'), fg = "green", height = 230, width= 265, command = face_recognize, compound = BOTTOM,borderwidth=5, relief=RAISED )
                B2.place(x = 20, y = 400)
                photo3 = PhotoImage(file = "Photos/train.png",  master = attendance)
                B3 =  Button(attendance , image = photo3 , text = "Train the Data" , font = ("helvetica", 15, 'bold italic'), fg = "green" , height = 230, width= 265, command = train , compound = BOTTOM,borderwidth=5, relief=RAISED )
                B3.place(x = 360, y = 100)
                photo4 = PhotoImage(file = "Photos/exit1.png",  master = attendance )
                B4 = Button(attendance, text="Exit",image = photo4, fg = "green",font = ("helvetica", 15,'bold italic'), height = 230, width = 265 , command = exit, compound = BOTTOM,borderwidth=5, relief=RAISED)
                B4.place(x =1040, y = 400)
                photo5 = PhotoImage(file = "Photos/report.png" ,  master = attendance)
                B5 = Button(attendance, text = "Attendance Report", fg = "green", font = ("helvetica", 15,'bold italic'), image = photo5, height = 230, width = 265, command = report, compound = BOTTOM,borderwidth=5, relief=RAISED)
                B5.place(x = 360, y = 400)
                photo6 = PhotoImage(file = "Photos/photosample.png",  master = attendance)
                B6 = Button(attendance, text = "Photo Samples" ,fg = "green", font =("helvetica",15,'bold italic'), image = photo6, height = 230, width = 265, command = photo_samples, compound = BOTTOM,borderwidth=5, relief=RAISED )
                B6.place(x = 700, y= 100) 
                photo7 = PhotoImage(file = "Photos/passwordchange.png", master = attendance)
                B7 = Button(attendance, text="Admin Account" ,fg = "green",font =("helvetica",15,'bold italic'), image = photo7, height = 230, width = 265, command = change, compound = BOTTOM,borderwidth=5, relief=RAISED )
                B7.place(x = 700, y = 400)
                photo8 = PhotoImage(file = "Photos/embeddings.png", master = attendance)
                B8 = Button(attendance, text = "Extract Embeddings", fg = "green", font = ("helvetica", 15, 'bold italic'), image = photo8, height = 230, width = 265,command= face_embedding, compound = BOTTOM,borderwidth=5, relief=RAISED)
...
title = Label(face, text = "Admin Login Page" , font = ("helvetica", 30, "bold italic"), bg = "green", fg = "yellow", bd = 7, relief = GROOVE) 
title.place(x = 0, y = 0, relwidth = 1)

clock = Label(face , font = ("helvetica",20,"bold italic"), bg = "green", relief = GROOVE)
...
user_label = Label(login_frame , text = "Username", image = user_icon, bg= "white", compound = LEFT, font = ("helvetica", 15, "bold italic")).grid( row  = 1 , column = 0, padx = 30, pady = 5)
user_entry = Entry(login_frame, font = ("helvetica", 15, "bold italic"), relief = GROOVE, textvariable = username_var, bg = "lightgray").grid(row = 1, column= 1, padx= 10, pady = 5)
password_label = Label(login_frame, text = "Password", image = password_icon, bg ="white", compound = LEFT, font = ("helvetica", 15, "bold italic")).grid(row = 2, column = 0, padx = 30, pady = 5)
password_entry = Entry(login_frame, show = "*", font = ("helvetica", 15,"bold"), relief = GROOVE, textvariable = password_var, bg = "lightgray").grid(row = 2, column = 1, padx = 20, pady = 5)
submit_btn = Button(login_frame, text = "Log In",width = 10, activebackground = "blue", activeforeground = "white", command = login , font = ("helvetica", 20, "bold"),relief = GROOVE, bg = "green").grid(row = 3, column = 1, pady =25, padx = 25) 
face.mainloop()            